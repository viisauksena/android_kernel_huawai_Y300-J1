...
static const struct sequence hx8369b_tianma_lcd_init_table[] =
{
	...
	{0x000D5,MIPI_GEN_COMMAND,0}, //GIP set GIP timing control
	...
	{0x0000F,TYPE_PARAMETER,0}, //18  CHR[7:0]
	{0x00030,TYPE_PARAMETER,0}, //19  CON[7:0]*
	{0x00012,TYPE_PARAMETER,0}, //20  COFF[7:0]*
	{0x00023,TYPE_PARAMETER,0}, //21  CHP[3:0], CCP[3:0] 
	...
	{0x0008F,TYPE_PARAMETER,0},
	{0x0000F,TYPE_PARAMETER,0}, //BTP[4:0]0D 
	{0x0001A,TYPE_PARAMETER,0}, //BTN[4:0]0D 
	{0x0001A,TYPE_PARAMETER,0},
	...
	{0x00000,TYPE_PARAMETER,0},   //0:Column; 1:1_dot; 2:2_dot; 3:4_dot; 4:8_dot
/*
	...
	{0x000B6,MIPI_GEN_COMMAND,0},//0xB6  set VCOM voltage
...
*/
	...
	{0x000E0,MIPI_GEN_COMMAND,0},//GAMMA=2.5
	{0x00000,TYPE_PARAMETER,0},
	...
	{0x000C7,MIPI_GEN_COMMAND,0},   //0xC7	To prohibit pwm 51khz output
	{0x00000,TYPE_PARAMETER,0}, 

	{0x000C9,MIPI_GEN_COMMAND,0},   //0xC9	set CABC related setting
	{0x0000F,TYPE_PARAMETER,0}, 
	{0x00000,TYPE_PARAMETER,0}, 

	{0x000EA,MIPI_GEN_COMMAND,0},   //0xEA	Write Display Brightness Value
	{0x0007A,TYPE_PARAMETER,0},     //PWM on
	
	{0x00051,MIPI_DCS_COMMAND,0},   //0x51	Write Display Brightness Value
	{0x00000,TYPE_PARAMETER,0},     //Write Display Brightness Value 

	{0x00053,MIPI_DCS_COMMAND,0},   //0x53	Write control display:close diming
	{0x00024,TYPE_PARAMETER,0},     //CABC on
	
	{0x00055,MIPI_DCS_COMMAND,0},   //0x55	Write content adaptive brightness control
