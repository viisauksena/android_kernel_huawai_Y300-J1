...
#									#
#	(c) 2014 moddingg33k <moddingg33k@t-online.de>			#
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++#
#----------------------[ General Setup ]--------------------------------#
...
KBUILD_CFLAGS	+= -Os $(call cc-disable-warning, uninitialized)
else
KBUILD_CFLAGS	+= -O2
endif
...
KBUILD_CFLAGS += -DCONFIG_HUAWEI_BT_BTLA_VER30
endif
ifeq ($(ENABLE_BLUEZ_VER30),true)
KBUILD_CFLAGS += -DCONFIG_HUAWEI_BT_BLUEZ_VER30
endif
